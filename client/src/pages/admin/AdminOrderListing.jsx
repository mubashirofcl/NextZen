                                    ...
                                    <tr key={order._id} className="group hover:bg-slate-50/50 transition-colors border-b border-slate-50 last:border-none">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[8px] text-slate-400 font-black tracking-widest uppercase italic">UUID: {order._id.slice(-8)}</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                <p className="text-xs font-black text-[#0F172A] uppercase italic leading-none mb-1">{order.userId?.name || "Unknown Entity"}</p>
                                                <p className="text-[10px] text-slate-400 lowercase truncate max-w-[140px] font-medium">{order.userId?.email}</p>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                ...
                                                <div className="flex items-center gap-1.5 mt-0.5">
                                                    <span className={`text-[7px] font-black uppercase px-1.5 py-0.5 rounded border ${order.paymentStatus?.toLowerCase() === 'paid' ? 'bg-green-50 text-green-600 border-green-100' : 'bg-orange-50 text-orange-600 border-orange-100'}`}>
                                                        {order.paymentStatus}
                                                    </span>
                                                    <span className="text-[7px] font-bold text-slate-300 uppercase tracking-tighter">{order.paymentMethod?.replace('cashOnDelivery', 'COD')}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                ...
                                                <p className="text-[8px] text-slate-300 font-bold uppercase">{new Date(order.updatedAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
                                            </div>
                                        </td>
