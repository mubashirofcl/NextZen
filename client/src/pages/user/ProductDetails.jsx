    ...
    return (
        <div className="relative min-h-screen font-sans text-white pt-16 selection:bg-[#7a6af6]/30">
            ...
            <main className="w-full px-4 md:px-8 lg:px-10 py-6 relative z-10">
                ...
                {/* 2. MAIN CONTAINER */}
                <div className="w-full border border-white/10 rounded-[2rem] overflow-hidden backdrop-blur-3xl bg-white/[0.01] flex flex-col lg:flex-row">
                        ...
                        <div className="space-y-6">
                            <header className="space-y-2">
                                ...
                                <div className="flex items-baseline gap-4">
                                    <span className={`text-4xl font-black italic ${isOutOfStock ? 'text-white/10' : ''}`}>₹{salePrice}</span>
                                    {originalPrice > salePrice && !isOutOfStock && (
                                        <span className="text-sm text-white/20 line-through font-bold italic opacity-50">₹{originalPrice}</span>
                                    )}
                                </div>
                            </header>
                            ...
                            <div className="space-y-4 pt-4">
                                ...
                                <p className="text-[10px] text-white/30 leading-relaxed font-medium italic line-clamp-3 hover:line-clamp-none transition-all duration-500">
                                    {product.description}
                                </p>
                            </div>
                        </div>
                        ...
                        {recommendedData.map((rec) => (
                            ...
                            >
                                ...
                                <div className="text-center px-1">
                                    ...
                                    <p className="text-[7px] font-bold uppercase tracking-[0.2em] text-white/10 italic">
                                        {rec.color}
                                    </p>
                                </div>
                            </div>
